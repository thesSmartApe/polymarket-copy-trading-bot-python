...
async def run_system_status_check():
    ...
    try:
        ...
        try:
            ...
            print(f'{Fore.YELLOW}[WARNING]{Style.RESET_ALL} Could not connect to database: {db_error}')
            print(f'{Fore.YELLOW}[INFO]{Style.RESET_ALL} Continuing with other checks...')
            print()
